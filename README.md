...
> **Checkpoint note (2026-05-17):** This theme repository received a checkpoint check-in on `main`; see recent history for the exact frontend/theme state captured in that snapshot.
